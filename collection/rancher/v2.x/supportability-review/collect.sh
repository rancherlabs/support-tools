...
CONTAINER_RUNTIME_ARGS="$CONTAINER_RUNTIME_ARGS -e BUNDLE_DIR="${BUNDLE_DIR}""
CONTAINER_RUNTIME_ARGS="$CONTAINER_RUNTIME_ARGS -e COLLECTOR_HTTP_PROXY="${COLLECTOR_HTTP_PROXY}""
CONTAINER_RUNTIME_ARGS="$CONTAINER_RUNTIME_ARGS -e COLLECTOR_HTTPS_PROXY="${COLLECTOR_HTTPS_PROXY}""
CONTAINER_RUNTIME_ARGS="$CONTAINER_RUNTIME_ARGS -e COLLECTOR_NO_PROXY="${COLLECTOR_NO_PROXY}""
